...
Mechanism: When creating a new process/thread with CLONE_FILES flag, the child shares the entire file descriptor table with the parent.
...
Mechanism: Child gets a copy of parent's FD table, but underlying struct file* objects are shared via get_file()
